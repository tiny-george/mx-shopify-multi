...
class ShopifyClientTest {
    private static final String EXISTING_CART_ID = "Z2NwLXVzLWNlbnRyYWwxOjAxSFJQOEMwWFc0RU5CVzhWREtSOERNMFBC";
    ...
    private static final String MAPPING_NAME_GET_CART_BY_ID = "?mapping-name=" + GET_CART_BY_ID;
    ...
    void shouldReturnValidCartWhenExistingIdIsProvided() {
        ShopifyGraphqlClient shopifyGraphqlClient = new ShopifyGraphqlClient(shopifyGraphqlUrl + MAPPING_NAME_GET_CART_BY_ID);
